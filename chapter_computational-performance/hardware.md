...
![Yanlış paylaşım (Görüntü Intel'in izniyle verilmektedir).](../img/falsesharing.svg)
...
![NVIDIA Turing işleme bloğu (Görüntü NVIDIA'nın izniyle verilmektedir).](../img/turing-processing-block.png)
:width:`150px`
